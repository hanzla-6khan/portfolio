...
export const Footer = () => {
    return (
        <div className="w-full py-20 h-auto border-b-[1px] border-b-black grid grid-cols-1 md:grid-cols-4 lgl:grid-cols-4 gap-8">
            <div className=" rounded-full flex flex-col gap-4">
                ...
                <div className="flex gap-4">
                    ...
                    <span className="bannerIcon">
                        ...
                        <a href="https://www.linkedin.com/in/hanzala-6khan/" target="_blank">
                            <FaLinkedinIn />
                        </a>
                    </span>
                </div>
